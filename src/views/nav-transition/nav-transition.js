...
async function navTransition(pageName) {
  ...
  const loginTag = '<li><a href="/login">로그인</a></li>';
  const logOutTag = '<li><a href="/" id="logout">로그아웃</a></li>';
  const registerTag = '<li class="register_btn"><a href="/register">회원가입</a></li>';
  const accountManageTag = '<li><a href="/account">계정관리</a></li>';
  const adminPageTag = '<li><a href="/admin">페이지 관리</a></li>';
  // const cartTag = `<li>
